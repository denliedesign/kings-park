...
<div class="box">
    <div class="box-inner d-flex align-items-center justify-content-center">
        <ul class="list-group">
            ...
            <li class="list-group-item"><a href="/policy">Policy</a></li>
            <li class="list-group-item"><a href="/classes">Classes</a></li>
            <li class="list-group-item"><a href="/parties">Parties</a></li>
...
{{--            <li class="list-group-item"><a href="/promotions">Events</a></li>--}}
            ...
            <li class="list-group-item"><a href="https://forms.gle/wh2sH1Tz6pTaSkx6A" target="_blank">Absences</a></li>
        </ul>
    </div>
</div>
