        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                    <div class="card-body">
                        <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=540329&loc=NPT &session=2021%20-%202022%20Fall%20Season&sort=days,starttime&showcols=loc "></script>
                    </div>
...
{{--                    </div>--}}
            ...
            <div class="card">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                    <div class="card-body">
                        <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=540329&loc=KP&session=2021%20-%202022%20Fall%20Season&sort=days,starttime&showcols=loc "></script>
                    </div>
{{--                    <div class="card-footer d-flex justify-content-center pb-5">--}}
{{--                        <div class="purple-rectangle text-center" style="width: 50%;">--}}
{{--                            <a href="/calendar" class="text-white">View Our Calendar</a>--}}
...
{{--                    </div>--}}
            ...
            <div class="card">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                    <div class="card-body">
                        <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=540329&loc=SMT &session=2021%20-%202022%20Fall%20Season&sort=days,starttime&showcols=loc "></script>
                    </div>
{{--                    <div class="card-footer d-flex justify-content-center pb-5">--}}
{{--                        <div class="purple-rectangle text-center" style="width: 50%;">--}}
{{--                            <a href="/calendar" class="text-white">View Our Calendar</a>--}}
